	             ...
	             if(isset($_POST['name'])&&!empty($_POST['name']))
		        {
			            if(preg_match("/^([a-zA-Z\s]+)$/", $_POST['name']))
			           {
			          ...
			          else
			              {
	                          ...
	                          <strong>please fill with Only lower and upper case and space </strong>
...
$blood_grouperror='<div class="alert alert-danger alert-dismissible fade show" role="alert">
  <strong>please select the blood_group</strong>
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true">&times;</span>
  </button>
</div>';
  ...
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true">&times;</span>
	                   ...
	                   }else
	                      {
                                      ...
                                      <strong>please select the day</strong>
                                       <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                       <span aria-hidden="true">&times;</span>
                                      </button>
                                      </div>';
	              }if(isset($_POST['month'])&&!empty($_POST['month']))
	          {
	               ...
	               }   else
	              {
							...
							<strong>please select the year</strong>
							<button type="button" class="close" data-dismiss="alert" aria-label="Close">
							<span aria-hidden="true">&times;</span>
                           </button>
                          </div>';
	              ...
	              if(isset($_POST['contact_no'])&&!empty($_POST['contact_no']))
	       {
		          ...
		          {
                     $conact=$_POST['contact_no'];
		          }
		            else
		              {
			               $conacterror='<div class="alert alert-danger alert-dismissible fade show" role="alert">
                            <strong>conact no consist aleast  11 </strong>
                           <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                           <span aria-hidden="true">&times;</span>
                           </button>
                           </div>';
	                    ...
	                    {
                                $conacterror='<div class="alert alert-danger alert-dismissible fade show" role="alert">
                                <strong>please fill the conact field</strong>
                               <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                               <span aria-hidden="true">&times;</span>
                               </button>
                              </div>';
	...
	if(isset($_POST['email'])&&!empty($_POST['email']))
	{
		   ...
		   if(preg_match($pattern, $_POST['email']))
		 {
           ...
           if(mysqli_num_rows($result)>0)
           {
                      ...
                      <strong> Sorry email already exist</strong>
                      <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                      </button>
                      </div>';
	    ...
	    else
	      {
	           ...
	           if(isset($_POST['password'])&&!empty($_POST['password'])&&isset($_POST['c_password'])&&!empty($_POST['c_password']))
	       {
		          if(strlen($_POST['password'])>=8)
		      {
			          ...
			          $passworderror='<div class="alert alert-danger alert-dismissible fade show" role="alert">
                      <strong>password lenghtshould be aleast 8x</strong>
                      <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                       <span aria-hidden="true">&times;</span>
                       </button>
                       </div>';
	                        ...
	                        $passworderror='<div class="alert alert-danger alert-dismissible fade show" role="alert">
                             <strong>please file the password </strong>
                             <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                             <span aria-hidden="true">&times;</span>
                              </button>
                              </div>';
             ...
             //database enter
               if(isset($name)&&isset($blood_group)&&isset($day)&&isset($month)&&isset($year)&&isset($email)&&isset($password)&&isset($city)&&isset($conact))	
           {
                           $donorDOB=$year."-".$month."-".$day;
                           $password =md5($password);
                            
                       $sql="INSERT INTO donor (name,gender,email,city,dob,phone,donated_date,password,blood_group) VALUES('$name','$gender','$email','$city','$donorDOB','$conact','0','$password','$blood_group')";
             ...
             {
	               $submiterorr='<div class="alert alert-danger alert-dismissible fade show" role="alert">
                   ...
                   <strong>please click on checkbox</strong>
                   <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                   <span aria-hidden="true">&times;</span>
                   </button>
                   </div>';
	...
	<div class="row">
		<div class="col-md-6 offset-md-3 form-container">
			<hr class="red-bar">
                    ...
                    if(isset($submiterorr)) echo $submiterorr;
          ...
          <!-- Error Messages -->
              ...
              <input type="text" name="contact_no"  placeholder="03********" class="form-control" required pattern="^\d{10}$" title="11 numeric characters only" maxlength="11" value="<?php
					if(isset($conact)) echo $conact;?>">
              <?php
					if(isset($conacterror)) echo $conacterror;?>
            </div><!--End form-group-->
					<div class="form-group">
